...
public class ZeroDeleteByIdsMethodGenerator extends
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        parameterType = introspectedTable.getPrimaryKeyColumns().get(0).getFullyQualifiedJavaType();
        listType.addTypeArgument(parameterType);

        List<IntrospectedColumn> introspectedColumns = introspectedTable
                .getPrimaryKeyColumns();
        method.addParameter(new Parameter(listType,introspectedColumns.get(0).getJavaProperty()+"s"));
