...
public class ZeroSaveElementGenerator extends AbstractXmlElementGenerator {

    private boolean isSimple;

    public ZeroSaveElementGenerator(boolean isSimple) {
        super();
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getSaveStatementId())); //$NON-NLS-1$
