...
public class Context extends PropertyHolder {
    ...
    private ZeroJavaModelVoGeneratorConfiguration zeroJavaModelVoGeneratorConfiguration;
    ...
    public ZeroJavaModelVoGeneratorConfiguration getZeroJavaModelVoGeneratorConfiguration() {
        return zeroJavaModelVoGeneratorConfiguration;
    }
    ...
    public void validate(List<String> errors) {
        ...
        if (zeroJavaModelVoGeneratorConfiguration == null) {
            errors.add(getString("ValidationError.31", id)); //$NON-NLS-1$
        } else {
            zeroJavaModelVoGeneratorConfiguration.validate(errors, id);
        }
    ...
    public void setZeroJavaModelVoGeneratorConfiguration(ZeroJavaModelVoGeneratorConfiguration zeroJavaModelVoGeneratorConfiguration) {
        this.zeroJavaModelVoGeneratorConfiguration = zeroJavaModelVoGeneratorConfiguration;
    }
