...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        context.setTargetPackage(attributes.getProperty("targetPackage"));
        context.setTargetProject(attributes.getProperty("targetProject"));
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            } else if ("javaModelVoGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
    ...
    protected void parseSqlMapGenerator(Context context, Node node) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage(properties.getProperty("targetPackage"));
        sqlMapGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\resources");
    ...
    protected void parseJavaModelGenerator(Context context, Node node) {
        ...
        javaModelGeneratorConfiguration.setTargetPackage(context.getTargetPackage() + ".model");
        javaModelGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\java");
    ...
    protected void parseJavaModelVoGenerator(Context context, Node node) {
        ZeroJavaModelVoGeneratorConfiguration zeroJavaModelVoGeneratorConfiguration
                = new ZeroJavaModelVoGeneratorConfiguration();

        context.setZeroJavaModelVoGeneratorConfiguration(zeroJavaModelVoGeneratorConfiguration);

        zeroJavaModelVoGeneratorConfiguration.setTargetPackage(context.getTargetPackage() + ".vo");
        zeroJavaModelVoGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\java");
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
                parseProperty(zeroJavaModelVoGeneratorConfiguration, childNode);
            }
        }
    }
    ...
    private void parseJavaClientGenerator(Context context, Node node) {
        ...
        javaClientGeneratorConfiguration.setTargetPackage(context.getTargetPackage() + ".dao");
        javaClientGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\java");
    ...
    private void parseJavaServiceGenerator(Context context, Node node) {
        ...
        javaServiceGeneratorConfiguration.setTargetPackage(context.getTargetPackage() + ".service");
        javaServiceGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\java");
    ...
    private void parseJavaControllerGenerator(Context context, Node node) {
        JavaControllerGeneratorConfiguration controllerGeneratorConfiguration = new JavaControllerGeneratorConfiguration();

        context.setJavaControllerGeneratorConfiguration(controllerGeneratorConfiguration);

        Properties attributes = parseAttributes(node);
        String controllerPath = attributes.getProperty("controllerPath"); //$NON-NLS-1$

        controllerGeneratorConfiguration.setTargetPackage(context.getTargetPackage() + ".controller");
        controllerGeneratorConfiguration.setTargetProject(context.getTargetProject() + "\\src\\main\\java");
        controllerGeneratorConfiguration.setControllerPath(controllerPath);
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
                parseProperty(controllerGeneratorConfiguration, childNode);
            }
        }
    }
