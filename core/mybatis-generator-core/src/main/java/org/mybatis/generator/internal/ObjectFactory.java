...
import org.mybatis.generator.codegen.mybatis3.ZeroIntrospectedTableMyBatis3Impl;
...
public class ObjectFactory {
    ...
    public static IntrospectedTable createIntrospectedTableForValidation(Context context) {
        ...
        }else if ("MyBatis3SimpleZero".equalsIgnoreCase(type)) { //$NON-NLS-1$
            type = ZeroIntrospectedTableMyBatis3Impl.class.getName();
        }
