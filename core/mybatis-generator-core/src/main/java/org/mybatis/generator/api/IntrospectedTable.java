...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_SAVE_STATEMENT_TYPE,
        ATTR_FIND_STATEMENT_TYPE,
        ATTR_FIND_BY_ID_STATEMENT_TYPE,
    ...
    public FullyQualifiedJavaType getPrimaryKeyJavaType() {
        FullyQualifiedJavaType IDType = null;
        if (this.getPrimaryKeyColumns().size() == 0) {
            IDType = new FullyQualifiedJavaType("java.lang.Void");
        } else if (this.getPrimaryKeyColumns().size() == 1) {
            IDType = this.getPrimaryKeyColumns().get(0).getFullyQualifiedJavaType();
        } else if (this.getPrimaryKeyColumns().size() > 1) {
            IDType = new FullyQualifiedJavaType(this.getBaseVoRecordType());
        } else {
            throw new RuntimeException("确定主键类型失败");
        }
    ...
    public String getBaseVoRecordType() {
        return internalAttributes.get(InternalAttribute.ATTR_BASEVO_RECORD_TYPE);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setDeleteByIdsStatementId("deleteByIds");
        setDeleteByIdStatementId("deleteById");
        setSaveStatementId("save");
        setFindByIdStatementId("findById");
        setFindStatementId("find");
        setUpdateStatementId("update");
        setCountStatementId("count");
    ...
    public void setUpdateStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_UPDATE_STATEMENT_ID, s);
    }

    public void setSaveStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SAVE_STATEMENT_TYPE, s);
    }

    public void setFindStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_FIND_STATEMENT_TYPE, s);
    }

    public void setFindByIdStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_FIND_BY_ID_STATEMENT_TYPE, s);
    }
    ...
    public String getDeleteByIdStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_DELETE_BY_ID_STATEMENT_ID);
    }

    public String getDeleteStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_DELETE_STATEMENT_ID);
    }

    public String getUpdateStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_UPDATE_STATEMENT_ID);
    }

    public String getSaveStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_SAVE_STATEMENT_TYPE);
    }

    public String getFindStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_FIND_STATEMENT_TYPE);
    }

    public String getFindByIdStatementId() {
        return internalAttributes.get(
                InternalAttribute.ATTR_FIND_BY_ID_STATEMENT_TYPE);
    }
    ...
    protected String calculateJavaModelVoPackage() {
        ZeroJavaModelVoGeneratorConfiguration config = context
                .getZeroJavaModelVoGeneratorConfiguration();
    ...
    protected void calculateModelVoAttributes() {
        String pakkage = calculateJavaModelVoPackage();
        ...
        setBaseVoRecordType(sb.toString());
    ...
    public void setBaseVoRecordType(String baseRecordType) {
        internalAttributes.put(InternalAttribute.ATTR_BASEVO_RECORD_TYPE,
                baseRecordType);
    }
